...
class AzureADAuthorization(AccessService):
    ...
    TRE_CORE_ROLES = ['TREAdmin', 'TREUser', 'ImperialTREAdmin']
    WORKSPACE_ROLES_DICT = {'WorkspaceOwner': 'app_role_id_workspace_owner', 'WorkspaceResearcher': 'app_role_id_workspace_researcher', 'AirlockManager': 'app_role_id_workspace_airlock_manager', 'ImperialWorkspaceResearcher': 'app_role_id_imperial_workspace_researcher' , 'ImperialWorkspaceOwner': 'app_role_id_imperial_workspace_owner', 'ImperialWorkspaceDataEngineer': 'app_role_id_imperial_workspace_dataengineer', 'ImperialAirlockManager': 'app_role_id_imperial_workspace_airlock_manager'}
    ...
    def get_workspace_role(self, user: User, workspace: Workspace, user_role_assignments: List[RoleAssignment]) -> WorkspaceRole:
        ...
        if RoleAssignment(resource_id=workspace_sp_id, role_id=workspace.properties['app_role_id_imperial_workspace_airlock_manager']) in user_role_assignments:
            return WorkspaceRole.ImperialAirlockManager
