                  ...
                  <Stack className="tre-panel">
                    <Stack.Item>
                      <Stack horizontal horizontalAlign="space-between">
                        <h1>Resources</h1>
                        <SecuredByRole allowedWorkspaceRoles={[WorkspaceRoleName.WorkspaceOwner, WorkspaceRoleName.WorkspaceResearcher, WorkspaceRoleName.WorkspaceDataEngineer, WorkspaceRoleName.AirlockManager]} element={
